...
- 実装前に該当する `docs/` を確認する。
- `docs/design/implementation-rules.md` を実装時のモジュール境界、ファイル肥大化防止、検証の正とする。
...
- 既存ファイルへ新しい責務を追加する前に、実装ルールの分割基準を確認する。例外は Issue または PR に理由を記載し、承認なしに適用しない。
